...
| **Expected Output** | Exact next authorized action is one bounded push-authorization decision for the two-commit local queue. Do not push, activate IWP-005, release, or deploy in that task. |
