...
Latest publication commit: `64b3b36` — publish Authentication Architecture authority
...
| **Publication commit** | `64b3b36` — publish Authentication Architecture authority |
