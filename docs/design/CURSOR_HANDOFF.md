...
Latest publication commit: Pending current publication commit — publish Development Standards authority
...
Pending checkpoint: None — Development Standards publication COMPLETE; publication commit pending current commit SHA; binding authority ACTIVE
