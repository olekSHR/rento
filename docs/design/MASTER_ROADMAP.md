...
| **Stage I2 Execution Authorization** | **PUBLISHED** — Stage I2 execution AUTHORIZED FOR EXECUTION ONLY - NOT STARTED; Work Package proposals NOT CREATED; Work Package authorization, activation, execution, implementation, audit/gap work, deployment, release, and Phase 4 NOT AUTHORIZED |
