...
There is no selected or active implementation work package after IWP-004 closure. IWP-004 is formally accepted and closed; IWP-005 remains not selected, not activated, and not authorized.
